...
export default function Home() {
  return (
    <div className="flex flex-col container mx-auto justify-center items-center">
      <Header />
      <div className="flex flex-col gap-14 mt-72">
        <div className="flex flex-col max-w-[907px] items-center text-center gap-8">
          ...
          >
            Utilizo JavaScript, React.js e Vue.js. Tenho experiência na criação
            de interfaces para Apps e sites, unindo desenvolvimento e design.
            Utilizo o Figma como principal ferramenta para elaborar protótipos e
            designs focados em usabilidade e experiência do usuário.
          </motion.p>
        </div>
